...
function initialize() {
	...
	function success(midi) {
		...
		function createUI(inputs) {
			...
			function onConnect() {
				...
				document.getElementById("midiNote").innerHTML = 'Sucessfully connected to selected device';
	...
	function failure() {
		...
		document.getElementById("midiNote").innerHTML = 'No access to your midi devices. Please check connection';
	}
